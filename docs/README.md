...
- **🆕 Backend Proxy Server**: REST API + WebSocket để giao tiếp với extension từ bất kỳ client nào
...
Extension hỗ trợ backend server để giao tiếp qua REST API và WebSocket.
...
Xem chi tiết trong [Backend Documentation](backend/README.md)
